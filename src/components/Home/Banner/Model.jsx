...
const Model = () => {
  ...
  return (
    <div className="flex  justify-center items-center hover:bg-white hover:text-black px-2 py-1 rounded-2xl " >
      ...
      {isOpen && (
        <div className="modal mx-2   overflow-hidden  absolute md:left-[17%] lg:left-[30%] rounded-xl   left-0 top-0  z-50 bg-white">
      ...
      {selectedCity && <p className="text-white hover:text-black" > {selectedCity}</p>}
    </div>
  );
};
